...
public class SupporterInventory implements InventoryProvider {
    public void update(Player p, InventoryContents contents) {}

    private static SmartInventory SupporterInv = SmartInventory.builder()
            .id("SupporterInv")
            .manager(AdminPannel.SmartInvsMan)
            .provider(new SupporterInventory())
            .title(ChatColor.YELLOW+"Supporter Pannel")
            .size(6,9)
            .build();
    ...
    public void init(Player p, InventoryContents contents) {
        ...
        //##################################################
        ItemStack Empty = new ItemStack(Material.BROWN_STAINED_GLASS_PANE);
        ...
        contents.set(1, 1, ClickableItem.empty(Empty));
        contents.set(1, 2, ClickableItem.empty(Empty));
        contents.set(1, 3, ClickableItem.empty(Empty));
        contents.set(1, 5, ClickableItem.empty(Empty));
        contents.set(1, 6, ClickableItem.empty(Empty));
        contents.set(1, 7, ClickableItem.empty(Empty));
        ...
        contents.fillRow(SupporterInv.getRows()-1, ClickableItem.empty(Nix));
        contents.set(SupporterInv.getRows()-1, 4, Close());
    }
